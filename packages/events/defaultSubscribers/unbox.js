  ...
  handlers: {
    ...
    "unbox:preparingToDownload:start": [
      function () {
        ...
        this.spinner = ora("Preparing to download box").start();
      }
    ],
    ...
    "unbox:downloadingBox:start": [
      function () {
        ...
        this.spinner = ora("Downloading").start();
      }
    ],
    ...
    "unbox:cleaningTempFiles:start": [
      function () {
        ...
        this.spinner = ora("Cleaning up temporary files").start();
      }
    ],
    ...
    "unbox:settingUpBox:start": [
      function () {
        ...
        this.spinner = ora("Setting up box").start();
      }
    ],
